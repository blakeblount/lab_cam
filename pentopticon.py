...
from PyQt6.QtWidgets import QApplication, QLabel, QMainWindow, QWidget, QHBoxLayout
...
class Pentopticon(QMainWindow):
    ...
    def update_frame(self):
        ...
        if ret0 and ret1:
            ...
            qimp0 = QImage(frame0.data, frame0.shape[1], frame0.shape[0], QImage.Format.Format_RGB888)
            qimp1 = QImage(frame1.data, frame1.shape[1], frame1.shape[0], QImage.Format.Format_RGB888)
